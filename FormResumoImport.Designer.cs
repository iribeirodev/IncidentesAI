...
{
    partial class FormResumoImport
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            dgvResumo.BackgroundColor = Color.RoyalBlue;
            dgvResumo.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvResumo.Dock = DockStyle.Bottom;
            dgvResumo.Location = new Point(0, 188);
            dgvResumo.Name = "dgvResumo";
            dgvResumo.ReadOnly = true;
            dgvResumo.Size = new Size(800, 262);
            dgvResumo.TabIndex = 0;
            // 
            // label1
            // 
